...
namespace DoubleDeckerBar.Adapters
{
    ...
    {
        internal static DoubleDeckerBar.Views.IConfigurationEntry ContractToViewAdapter(Start9.Api.Contracts.IConfigurationEntryContract contract)
        {
            if ((contract == null))
            {
                return null;
        ...
        internal static Start9.Api.Contracts.IConfigurationEntryContract ViewToContractAdapter(DoubleDeckerBar.Views.IConfigurationEntry view)
        {
            if ((view == null))
            {
                return null;
