...
namespace DoubleDeckerBar.Adapters
{
    ...
    {
        internal static DoubleDeckerBar.Views.MessageReceivedEventArgs ContractToViewAdapter(Start9.Api.Contracts.IMessageReceivedEventArgsContract contract)
        {
            if ((contract == null))
            {
                return null;
        ...
        internal static Start9.Api.Contracts.IMessageReceivedEventArgsContract ViewToContractAdapter(DoubleDeckerBar.Views.MessageReceivedEventArgs view)
        {
            if ((view == null))
            {
                return null;
