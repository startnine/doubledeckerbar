...
namespace DoubleDeckerBar.Adapters
{
    ...
    {
        internal static DoubleDeckerBar.Views.IReceiverContract ContractToViewAdapter(Start9.Api.Contracts.IReceiverContractContract contract)
        {
            if ((contract == null))
            {
                return null;
        ...
        internal static Start9.Api.Contracts.IReceiverContractContract ViewToContractAdapter(DoubleDeckerBar.Views.IReceiverContract view)
        {
            if ((view == null))
            {
                return null;
