...
namespace DoubleDeckerBar.Adapters
{
    ...
    {
        internal static DoubleDeckerBar.Views.IReceiverEntry ContractToViewAdapter(Start9.Api.Contracts.IReceiverEntryContract contract)
        {
            if ((contract == null))
            {
                return null;
        ...
        internal static Start9.Api.Contracts.IReceiverEntryContract ViewToContractAdapter(DoubleDeckerBar.Views.IReceiverEntry view)
        {
            if ((view == null))
            {
                return null;
