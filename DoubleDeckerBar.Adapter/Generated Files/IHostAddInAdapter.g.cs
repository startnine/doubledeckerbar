...
namespace DoubleDeckerBar.Adapters
{
    ...
    {
        internal static DoubleDeckerBar.Views.IHost ContractToViewAdapter(Start9.Api.Contracts.IHostContract contract)
        {
            if ((contract == null))
            {
                return null;
        ...
        internal static Start9.Api.Contracts.IHostContract ViewToContractAdapter(DoubleDeckerBar.Views.IHost view)
        {
            if ((view == null))
            {
                return null;
