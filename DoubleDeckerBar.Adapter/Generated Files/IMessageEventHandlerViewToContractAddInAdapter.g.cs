...
namespace DoubleDeckerBar.Adapters
{
    ...
    public class IMessageEventHandlerViewToContractAddInAdapter : System.AddIn.Pipeline.ContractBase, Start9.Api.Contracts.IMessageEventHandlerContract
    {
        ...
        {
            DoubleDeckerBar.Views.MessageReceivedEventArgs adaptedArgs;
            adaptedArgs = DoubleDeckerBar.Adapters.MessageReceivedEventArgsAddInAdapter.ContractToViewAdapter(args);
