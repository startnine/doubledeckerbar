...
namespace DoubleDeckerBar.Adapters
{
    ...
    {
        internal static DoubleDeckerBar.Views.IModuleAssembly ContractToViewAdapter(Start9.Api.Contracts.IModuleAssemblyContract contract)
        {
            if ((contract == null))
            {
                return null;
        ...
        internal static Start9.Api.Contracts.IModuleAssemblyContract ViewToContractAdapter(DoubleDeckerBar.Views.IModuleAssembly view)
        {
            if ((view == null))
            {
                return null;
