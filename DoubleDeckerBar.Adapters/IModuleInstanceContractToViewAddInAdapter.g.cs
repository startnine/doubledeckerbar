...
namespace DoubleDeckerBar.Adapters
{
    ...
    public class IModuleInstanceContractToViewAddInAdapter : DoubleDeckerBar.Views.IModuleInstance
    {
        ...
        public DoubleDeckerBar.Views.IModule Instance
        {
            get
            {
                return DoubleDeckerBar.Adapters.IModuleAddInAdapter.ContractToViewAdapter(_contract.Instance);
            }
        }
