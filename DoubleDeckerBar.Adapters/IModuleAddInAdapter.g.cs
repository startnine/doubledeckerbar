...
namespace DoubleDeckerBar.Adapters
{
    ...
    {
        internal static DoubleDeckerBar.Views.IModule ContractToViewAdapter(Start9.Api.Contracts.IModuleContract contract)
        {
            if ((contract == null))
            {
                return null;
        ...
        internal static Start9.Api.Contracts.IModuleContract ViewToContractAdapter(DoubleDeckerBar.Views.IModule view)
        {
            if ((view == null))
            {
                return null;
